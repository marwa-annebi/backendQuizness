...
const sendPasswordLinkAdmin = async (req, res, next) => {
...
const setNewPasswordAdmin = async (req, res, next) => {
  try {
...
module.exports = { sendPasswordLinkAdmin, setNewPasswordAdmin, confirmResetPassword };
